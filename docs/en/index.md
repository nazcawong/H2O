...
**English** | [中文](../zh-Hant/index.md)

Short public docs. Historical knife logs stay in `docs/*.md` (mostly Chinese) and are not the front door.

| Page | What it is |
|---|---|
| [language.md](language.md) | Syntax, one way to write a thing, Core 1 |
